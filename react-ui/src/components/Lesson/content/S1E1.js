  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>一，二，三, <strong>yī</strong>, <strong>èr</strong>, <strong>sān</strong>.</p>
        <p>Before tone four and neutral tone it has tone two:</p>
        <p>一个人, <strong>yí ge̊ rén</strong> <em>a person</em>; <em>one person</em></p>
        <p>Before tones one, two and three, it has tone four:</p>
        <p>一本书 <strong>yì běn shū</strong> <em>a book</em>; <em>one book</em><br/>一点 <strong>yì diǎn</strong> <em>a bit</em>; <em>a little bit</em><br/>一点 <strong>yì diǎndiǎn</strong> <em>a tiny bit</em>; <em>a tiny little bit</em></p>
        <c.GrammarTitle letter={getGrammarLetter()}>
        ...
        <p>But Chinese uses measure words for <em>all</em> nouns, not just things that can be &quot;measured&quot; like a liter of milk. You cannot just say <em>a book</em> or <em>a language</em>; you have to say <em>a &quot;volume&quot; of book</em> and <em>a &quot;portal&quot; of language</em>. English has a similar phenomenon with uncountable nouns: we say <em>a piece of news</em> rather than just <em>a news</em>. Here, <em>piece</em> is the measure word for <em>news</em>. The difference is that Chinese treats <em>all</em> nouns in this way.</p>
          ...
          <p>本, <strong>běn</strong>, <em>root</em>: classifier  for books<br/>门, <strong>mén</strong>, <em>door</em>: classifier for languages, academic subjects - and artillery pieces!<br/>个, <strong>ge̊</strong>, <em>piece</em>: the most common classifier, used as a &quot;general&quot; measure for many different nouns</p>
          ...
          <p>一本书 <strong>yì běn shū</strong> <em>a book</em> OR <em>one book</em> (ONE ROOT-OF BOOK)<br/>这本书 <strong>zhèi běn shū</strong> <em>this book</em> (THIS ROOT-OF BOOK)<br/>那本书 <strong>nèi běn shū</strong> <em>that book</em> (THAT ROOT-OF BOOK)<br/>三门语言 <strong>sān mén yǔyán</strong> (THREE PORTAL-OF LANGUAGE)<br/>一个人 <strong>yí ge̊ rén</strong> <em>a person</em> (ONE PIECE-OF PERSON)<br/>这个人 <strong>zhèi ge̊ rén</strong> <em>this person</em> (THIS PIECE-OF PERSON)<br/>那个人 <strong>nèi ge̊ rén</strong> <em>that person</em> (THAT PIECE-OF PERSON)<br/>一个姓 <strong>yí ge̊ xìng</strong> <em>a family name</em> (ONE PIECE-OF FAMILY-NAME)<br/>这个姓名 <strong>zhèi ge̊ xìngmíng</strong> <em>this name</em> (THIS PIECE-OF NAME)<br/>那个名字 <strong>nèi ge̊ míngzi̊</strong> <em>that given name</em> (THAT PIECE-OF GIVEN-NAME)</p>
