    ...
    return (
      <div>
        <c.Page>
          ...
          <c.Bookrow>{character(3, { mode: 'practice' })}</c.Bookrow>
          <c.Bookrow>{character(4, { mode: 'practice' })}</c.Bookrow>
          <c.Bookrow>{character(5, { mode: 'practice' })}</c.Bookrow>
          ...
          <c.P>Practice pronunciation, grammar and character writing on the ChineseMe website.</c.P>
        </c.Page>
      </div>
    );
  }
