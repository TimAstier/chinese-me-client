  ...
  render() {
    return (
      <div>
        ...
        <c.Bookrow><img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/pie_stroke.png" alt="" /></c.Bookrow>
        ...
        <c.Bookrow><img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/na_stroke.png" alt="" /></c.Bookrow>
        <c.P>The foot should not be at an angle with the rest of the stroke; this will create an ugly, broken impression:</c.P>
        <c.Bookrow><img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/broken_ren.png" alt="" /></c.Bookrow>
