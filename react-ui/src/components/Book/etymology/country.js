  ...
  render() {
    return (
      <div>
        ...
        <c.Bookrow>
          <img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/country_1.png" alt="" />
        </c.Bookrow>
        ...
        <c.Bookrow>
          <img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/country_2.png" alt="" />
        </c.Bookrow>
        ...
        <c.Bookrow>
          <img src="https://s3.eu-west-2.amazonaws.com/chineseme/images/country_3.png" alt="" />
        </c.Bookrow>
      </div>
    );
  }
