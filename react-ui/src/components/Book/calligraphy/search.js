  ...
  render() {
    return (
      <div>
        ...
        <c.P>This character can be confusingly similar to <c.Chinese>我</c.Chinese> <b>wǒ</b>, but the <i>hand</i> radical in <c.Chinese>找</c.Chinese> <b>zhǎo</b> doesn’t have any dot at the top, and the long slanting horizontal stroke in <c.Chinese>我</c.Chinese> is matched by two separate strokes in <c.Chinese>找</c.Chinese>.</c.P>
        <c.Bookrow>
          <c.CharacterBox simpChar="找" />
        </c.Bookrow>
        <c.Bookrow>
